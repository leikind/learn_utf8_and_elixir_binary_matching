defmodule Utf8EncoderV4 do
  ...
  def codepoint_to_binary(codepoint) when codepoint <= 0b111111111111111111111 do
    <<three_bits::size(3), six_bits::size(6), six_bits2::size(6), six_bits3::size(6)>> =
      <<codepoint::size(21)>>
